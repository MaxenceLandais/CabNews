...
export const SIGNALS: WeakSignalItem[] = [
  ...
  {
    id: "sig-pac-leasing",
    title: "Leasing PAC : la décision est encore dans le PLF, pas dans un décret",
    thesis: "Le dispositif a été annoncé (25 000 ménages, mensualité ≤ gaz). Sans ligne 2027, c’est un communiqué. Agrément CEE + préférence UE au 1er sept. : la filière est déjà sous tension.",
    evidence: [
      "Les Échos / Le Parisien : appel à projets, DGEC, zéro reste à charge.",
      "Bercy janvier : bonification CEE conditionnée à la production européenne.",
      "Installations PAC en repli depuis 2023.",
    ],
    watch: "Fuites PLF, décret DGEC, liste des lauréats de l’appel. Un non de Bercy = papier filière.",
    risk: "macro",
    sectors: ["energy", "industry", "budget"],
    entities: ["DGEC", "EDF", "Sébastien Martin"],
    source: "Les Échos, Bercy, Synasav",
    sources: [
      { label: "Les Échos", url: "https://www.lesechos.fr/industrie-services/energie-environnement/plan-delectrification-apres-les-voitures-le-gouvernement-inaugure-le-leasing-social-de-pompes-a-chaleur-2241077" },
      { label: "Bercy", url: "https://presse.economie.gouv.fr/?p=169103" },
    ],
  },
  {
    id: "sig-chapsvision",
    title: "ChapsVision : un Palantir français qui n’est plus une rumeur",
    thesis: "DGSI + BfV + discussions UE. 200 M€ CA, ArgonOS. Si le déploiement glisse, c’est un papier souveraineté, pas un papier start-up.",
    evidence: [
      "Lecornu a tranché Palantir. Lescure parle de plusieurs mois.",
      "Sansoni à VivaTech : tous les États européens, Asie, Moyen-Orient, Ukraine.",
    ],
    watch: "Arrêtés, marchés publics, nominations DNUM, titres Seeking Alpha s’il y a une intro.",
    risk: "deal",
    sectors: ["ia", "tech", "defense"],
    entities: ["ChapsVision", "Olivier Dellenbach", "DGSI"],
    source: "BFMTV, Les Échos, Le Figaro",
    sources: [
      { label: "BFMTV", url: "https://www.bfmtv.com/" },
      { label: "Les Échos", url: "https://www.lesechos.fr/" },
    ],
  },
  {
    id: "sig-valeo-drones",
    title: "Valeo : l’auto ne paie plus, le drone doit payer la marge",
    thesis: "Usine AuRA le 24 sept. Si la cadence 2027 n’est pas chiffrée sur site, c’est une inauguration, pas une conversion industrielle.",
    evidence: [
      "Contrat Harmattan AI, moteurs sans terres rares lourdes.",
      "CA S1 2026 : 10,38 Md€, recherche de relais (datacenters, humanoïdes, drones).",
      "Sénat : stock drones FR insuffisant.",
    ],
    watch: "Emplois, capacité mensuelle, client unique vs multi-dronistes, comparatif Schaeffler/Delair.",
    risk: "deal",
    sectors: ["auto", "defense", "industry"],
    entities: ["Valeo", "Harmattan AI", "Christophe Périllat"],
    source: "La Tribune, Reuters",
    sources: [
      { label: "La Tribune", url: "https://www.latribune.fr/" },
      { label: "Reuters", url: "https://www.marketscreener.com/news/france-s-drone-production-shifts-from-policy-ambition-to-factory-floor-ce7f50dfd18bf52c" },
    ],
  },
  {
    id: "sig-arcelor-cbam",
    title: "Arcelor France : le CBAM vaut plus qu’une visite de site",
    thesis: "Mardi 22, visite + Bercy Made in Europe. L’acier électrique (China Oriental, 2027) et Fos/Dunkerque se lisent dans le tarif carbone, pas dans le ruban.",
    evidence: [
      "Industeel Le Creusot 52 M€, France 2030.",
      "Hausse prix HRS Europe +20 €/t début sept.",
      "Kryvyi Rih attaqué.",
    ],
    watch: "Site visité le 22, phrases Martin, position CBAM au Conseil compétitivité du 24.",
    risk: "macro",
    sectors: ["industry", "chine", "ukraine"],
    entities: ["ArcelorMittal", "Sébastien Martin"],
    source: "Usine Nouvelle, GMK",
    sources: [
      { label: "Usine Nouvelle", url: "https://www.usinenouvelle.com/metallurgie-siderurgie/arcelormittal/" },
